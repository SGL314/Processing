class Padrao{
    ...
    */
    ...
    layoutBlocosCentrais = {6,6,7,7,8,8,9,9,10},
    layoutBlocoLateralDireito = {4,6,7,8,7,8,7,7},
    layoutBlocoLateralEsquerdo = {4,6,7,8,8,8,7,7},
    diferencaFileiraLateralDireitaP =  {0,1.0,1.0,1.0,2.0,1.0,1.0,1.0,1.0},
    ...
    // Apresentation
    float addingDownLat = 2; // ajustado em init
