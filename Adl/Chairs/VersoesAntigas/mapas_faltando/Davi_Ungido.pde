class Davi_Ungido{
    ...
    layoutBlocoLateralDireito =  {6,7,8,8,8,8,8},
    layoutBlocoLateralEsquerdo = {6,7,8,8,8,8,8},
    ...
    // Apresentation
    float addingDownLat = 4.5; // ajustado em init
    float addingDownCen = 2.5; // ajustado em init -> 2 = duas fileiras a mais
    String textoExport = "";
