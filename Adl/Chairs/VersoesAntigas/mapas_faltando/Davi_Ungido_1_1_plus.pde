class Davi_Ungido{
    ...
    layoutBlocosCentrais =       {9,9,9,9,9,9,9,9,9,9,9,9},
    layoutBlocoLateralDireito =        {7,8,8,8,8,8,7,8,6},
    layoutBlocoLateralEsquerdo =       {7,8,8,8,8,8,8,8,6},
    ...
    // Apresentation
    float addingDownLat = 5.5; // ajustado em init
    float addingDownCen = 3.5; // ajustado em init -> 2 = duas fileiras a mais
    String textoExport = "";
    ...
    void init(){
        ...
        espacoEntreFileiras = 3*tamQuadrado-tamCadeira-16*coeCmToPx;
        println("espacoEntreFileiras: "+espacoEntreFileiras/coeCmToPx+"cm");
        espacoEntreFileirasLaterais=3*tamQuadrado; // -2*tamCadeira + 3*sqrt(2)*tamCadeira + tamCadeira;
        println("espacoEntreFileiras: "+espacoEntreFileirasLaterais/coeCmToPx+"cm");
