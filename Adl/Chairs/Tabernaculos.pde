class Tabernaculos extends Modelo {
  int longitude = 30,
  ...
  float[] distBlocos= {7.0, 8.0}, // {7.0,7.0} {10.0,10.0}
    // layoutBlocosCentrais =       {8,8,8,8,8,8,8,8,8,8,8},
    // layoutBlocoLateralDireito =        {5,7,8,7,8,8,8,8},
    // layoutBlocoLateralEsquerdo =       {5,7,8,8,8,8,8,8},

    layoutBlocosCentrais =       {8, 8, 8, 8, 8, 8, 8, 8, 8,8,8},
    layoutBlocoLateralDireito =        {6, 7, 8, 8, 8, 8, 8,8},
    layoutBlocoLateralEsquerdo =       {6, 7, 8, 8, 8, 8, 8,8},
  ...
  void painelDeLuz() {
    ...
    float tx = 100, ty=10,
      ...
      py = espessuraAltar+(altura-2)*tamQuadrado;
    rect(px, py, tx, ty);
  }
  ...
  void linhasImaginarias() {
    ...
    texto = "Meio do Nobre";
    px = 510;
    py = 605+addingDownCen - 4*tamQuadrado;
    noStroke();
    // textSize(size);
    // rect(px, py-size+3, textWidth(texto), size);
    // fill(#ff0000);
